...
var options = {
  src: './AQIService/static/js/index.js',
  dest: './AQIService/static/js/',

  modernizr: {
    src: './AQIService/static/js/index.js',
    dest: './AQIService/static/libs/',
  },

  css: {
    src: './AQIService/static/less/index.less',
    watch: './AQIService/static/less/**/*.less',
    dest: './AQIService/static/css/'
  },
  development: false
}
...
gulp.task('test', gulp.series(function () {
  ...
  return gulp
    .src('./AQIService/static/js/app/**/*.js')
    .pipe(istanbul({
    ...
    .on('finish', function () {
      gulp
        .src('./AQIService/static/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
